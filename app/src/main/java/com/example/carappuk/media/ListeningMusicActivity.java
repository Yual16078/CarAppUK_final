...
public class ListeningMusicActivity extends AppCompatActivity implements MediaPlayer.OnCompletionListener {
        ...
        rxPermissions.request(Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                .subscribe(granted -> {
                    if (granted) {//请求成功之后开始扫描
                        ...
                        ToastUtils.showShortToast(ListeningMusicActivity.this, "未授权");
                    }
                });
    }
